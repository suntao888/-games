...
while True:
    ...
    my_text = font.render(str(score), True, (255, 255, 255))
    ...
    if ball_y <= 20:
        ...
        if count == 3:
            ...
            if move_x > 0:
                ...
                move_x -= 1
            move_y -= 1
    elif ball_y > 480 and (ball_x < mouse_x - 40 or ball_x > mouse_x + 140):
        break
    pg.display.update()
    time.sleep(0.005)
print("游戏结束,您得分为%d" % (score))
